...
SCr = MicroBits(int('1000000000000',2),0,0)
PCe = MicroBits(int('0100000000000',2),0,0)
SUB = MicroBits(int('0010000000000',2),0,0)
HLT = MicroBits(int('0000010000000',2),0,0)
OUT = MicroBits(int('0000001000000',2),0,0)
Jump = MicroBits(0,int('1000000000000',2),0)
SUMf = MicroBits(0,int('0100000000000',2),0)
RMi = MicroBits(0,int('0000010000000',2),0)
IRi = MicroBits(0,int('0000001000000',2),0)
Ai = MicroBits(0,int('0000000100000',2),0)
Bi = MicroBits(0,int('0000000010000',2),0)
ARi = MicroBits(0,int('0000000000010',2),0)
PCo = MicroBits(0,0,int('1000000000000',2))
SUMo = MicroBits(0,0,int('0100000000000',2))
RMo = MicroBits(0,0,int('0000010000000',2))
IRo = MicroBits(0,0,int('0000001000000',2))
Ao = MicroBits(0,0,int('0000000100000',2))
Bo = MicroBits(0,0,int('0000000010000',2))
